...
import {
  ...
  Wrench, AlertTriangle, TrendingUp, Receipt, Banknote, UserCog, IdCard, ClipboardList, LogOut, ScrollText, RefreshCw, Shield, MessageSquare, UsersRound, Building2, Undo2, FileSignature,
} from "lucide-react";
import {
...
const adminItems: Item[] = [
  ...
  { title: "Send Task", url: "/admin/send-task", icon: ClipboardList, roles: ["admin"] },
  { title: "Completed Inspections", url: "/admin/completed-inspections", icon: ClipboardCheck, roles: ["admin"] },
