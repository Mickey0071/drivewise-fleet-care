...
export const DEFAULT_SETTINGS: AgreementSettings = {
  ...
  clauses: [
    ...
    { title: "Rental Extension Option", body: "You may request to extend your rental beyond the agreed end date. If you choose to extend: (a) {{COMPANY}} will prepare an Extension Agreement documenting the new end date; (b) the extension cost will be calculated based on your daily/weekly rental rate; (c) you will receive a secure link to review, sign, and authorize payment for the extension; (d) your card on file will be charged for the extension amount upon your signature; (e) once signed, your rental will be extended to the new date; and (f) an updated receipt and extension document will be provided for your records." },
  ],
  agreementVersion: "camauto-2026-05-ext",
};
